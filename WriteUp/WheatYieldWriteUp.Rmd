...
setwd('C:\\Users\\mmann\\Desktop\\India-Index-Insurance-Code\\WriteUp')
...
###Annual Metrics
Basic annual summary statics including minimum, maximum, standard deviations can be calcuated using `r paste(Appendix_Function_number)` below.
