...
One major hurdle for this study was the rapid extraction of raster values bases on vector data. Function `r J=Appendix_Function_number` `r paste(J)` `r Appendix_Function_number=Appendix_Function_number+1` in the appendix, processing times were better that 1/10th that of the default raster::extract() function with the use of a 16-core linux server.
