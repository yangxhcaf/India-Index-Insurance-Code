...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Remote Sensing of Wheat and Rice Yields in India':' Algorithms for growing season statistics},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Remote Sensing of Wheat and Rice Yields in India':' Algorithms for
growing season statistics}
    \author[The George Washington University]{Michael Mann\corref{c1}}
