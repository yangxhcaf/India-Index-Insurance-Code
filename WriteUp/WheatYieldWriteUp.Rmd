...
# Plot temporal and spatial fit  ------------------------------------------
  ...
  # PROBLEM WITH model_data_pca wrong values.... 
  cbind(model_data_lm[  model_data_lm$district=='AMBALA'& model_data_lm$variable=='yield_tn_ha',],  model_data_pca[  model_data_pca$district=='AMBALA'& model_data_pca$variable=='yield_tn_ha',],model_pca_splm_lag[  model_pca_splm_lag$district=='AMBALA'& model_pca_splm_lag$variable=='yield_tn_ha',])
